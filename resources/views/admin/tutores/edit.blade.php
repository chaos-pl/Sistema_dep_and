...
@section('title', 'Editar Tutor - PROMETEO')
@section('page-title', 'Editar Tutor')
@section('page-subtitle', 'Actualización de expediente y credenciales')
        ...
        <div class="col-lg-10">
            <div class="app-card p-4 p-md-5 border-0 shadow-sm rounded-4">
                <div class="d-flex align-items-center gap-3 mb-4 border-bottom pb-3">
                    ...
                    <div>
                        <h4 class="fw-black mb-1 text-body">Modificando Tutor</h4>
                        <p class="text-body-secondary mb-0 small">Actualiza la información personal o cambia la contraseña.</p>
                    </div>
                </div>
