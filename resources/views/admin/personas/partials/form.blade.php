<div class="row g-4">
    <div class="col-md-12 mb-2">
        <label class="form-label fw-bold text-secondary">Usuario vinculado al sistema</label>
        <div class="input-group">
            <span class="input-group-text bg-light border-end-0 text-muted px-3"><i class="bi bi-envelope-at-fill"></i></span>
            <select name="user_id" class="form-select form-select-lg bg-light border-start-0 ps-0">
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="nombre" class="form-control form-control-lg bg-light" value="{{ old('nombre', $persona->nombre ?? '') }}" placeholder="Ej. Juan Carlos" required>
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="apellido_paterno" class="form-control form-control-lg bg-light" value="{{ old('apellido_paterno', $persona->apellido_paterno ?? '') }}" placeholder="Ej. Pérez" required>
    ...
    <div class="col-md-4">
        <label class="form-label fw-bold text-secondary">Apellido materno <span class="text-muted fw-normal">(Opcional)</span></label>
        <input type="text" name="apellido_materno" class="form-control form-control-lg bg-light" value="{{ old('apellido_materno', $persona->apellido_materno ?? '') }}" placeholder="Ej. López">
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="date" name="fecha_nacimiento" class="form-control form-control-lg bg-light border-start-0 ps-0" value="{{ old('fecha_nacimiento', $persona->fecha_nacimiento ?? '') }}" required>
        </div>
    ...
    <div class="col-md-4">
        <label class="form-label fw-bold text-secondary">Teléfono <span class="text-muted fw-normal">(Opcional)</span></label>
        <div class="input-group">
            <span class="input-group-text bg-light border-end-0 text-muted"><i class="bi bi-telephone"></i></span>
            <input type="text" name="telefono" class="form-control form-control-lg bg-light border-start-0 ps-0" value="{{ old('telefono', $persona->telefono ?? '') }}" placeholder="10 dígitos">
        </div>
...
<div class="d-flex justify-content-between mt-5 pt-4 border-top">
    <a href="{{ route('admin.personas.index') }}" class="btn btn-light border px-4 rounded-pill fw-bold text-secondary shadow-sm">
