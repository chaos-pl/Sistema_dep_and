...
@section('content')
    <div class="app-card p-4 p-md-5">
        ...
        <div class="row align-items-center justify-content-between mb-5 gy-3">
            <div class="col-lg-5">
                <h4 class="fw-black text-dark mb-1"><i class="bi bi-person-lines-fill text-primary me-2"></i>Personas Registradas</h4>
                <p class="text-muted mb-0">Consulta la información personal vinculada a los usuarios.</p>
            </div>
            ...
            <div class="col-lg-7 d-flex flex-column flex-sm-row justify-content-lg-end gap-3">
                <div class="position-relative w-100" style="max-width: 320px;">
                    ...
                    <input type="text" id="searchInput" class="form-control bg-light rounded-pill border-0 shadow-sm search-input-prometeo" placeholder="Buscar por nombre..." onkeyup="filterPersonas()">
                </div>
        ...
        <div class="table-responsive">
            <table class="table align-middle table-hover" id="personasTable">
                <thead class="bg-light">
                <tr>
                    <th class="py-3 px-4 rounded-start-3 text-muted fw-bold">ID / Nombre</th>
                    <th class="py-3 text-muted fw-bold">Usuario Vinculado</th>
                    <th class="py-3 text-muted fw-bold">Nacimiento</th>
                    <th class="py-3 text-muted fw-bold text-center">Género</th>
                    <th class="py-3 text-muted fw-bold">Teléfono</th>
                    ...
                    <tr class="persona-row">
                        <td class="px-4 py-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-0 text-dark persona-name">
                        ...
                        <td class="py-3">
                            @if($persona->user)
                                <span class="badge bg-light text-primary border border-primary border-opacity-25 rounded-pill px-3 py-2 fw-medium">
                                    <i class="bi bi-envelope-at-fill me-1"></i> {{ $persona->user->email }}
                                </span>
                            @else
                                <span class="badge bg-light text-muted border border-secondary border-opacity-25 rounded-pill px-3 py-2 fw-medium">
