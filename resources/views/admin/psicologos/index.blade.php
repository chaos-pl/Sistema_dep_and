    ...
    <div class="app-card p-4 p-md-5 border-0 shadow-sm rounded-4">
        ...
        <div class="row align-items-center justify-content-between mb-5 gy-3">
            ...
            <div class="col-lg-7 d-flex flex-column flex-sm-row justify-content-lg-end gap-3">
                ...
                <a href="{{ route('admin.psicologos.create') }}" class="btn btn-primary rounded-pill fw-bold shadow-sm d-flex align-items-center justify-content-center px-4" style="padding-top: 0.7rem; padding-bottom: 0.7rem;">
                    ...
                    <tr class="psico-row border-bottom border-secondary border-opacity-10">
                        ...
                        <td class="text-end px-4 py-3 border-0">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ route('admin.psicologos.edit', $psicologo->id) }}" class="btn btn-sm btn-light border text-warning rounded-circle shadow-sm" style="width: 35px; height: 35px; display: inline-flex; align-items: center; justify-content: center;" title="Editar">
