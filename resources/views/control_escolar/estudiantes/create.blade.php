@extends('layouts.app')
@section('title', 'Nuevo Estudiante - Control Escolar')
@section('page-title', 'Registrar Estudiante')
@section('page-subtitle', 'Alta de un nuevo estudiante en el sistema')
@section('content')
<div class="app-card p-4 p-md-5 mb-4">
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div><h4 class="fw-black text-body mb-1"><i class="bi bi-mortarboard-fill text-primary me-2"></i>Nuevo Estudiante</h4><p class="text-body-secondary mb-0">Completa los datos para registrar un nuevo estudiante.</p></div>
    ...
    <form action="{{ route('control_escolar.estudiantes.store') }}" method="POST">@csrf
        <div class="row g-4">
        ...
        <div class="d-flex justify-content-end gap-3 mt-5 pt-4 border-top border-secondary border-opacity-10">
            ...
            <button type="submit" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm"><i class="bi bi-floppy-fill me-2"></i>Registrar Estudiante</button>
        </div>
    </form>
</div>
@endsection
